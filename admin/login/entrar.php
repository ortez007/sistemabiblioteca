...
$query = mysqli_query($conexion, "SELECT username,password, imagen FROM usuarios WHERE username = '$username'") or die(mysql_error());
...
if($_POST['recordar']){
	...
	$query = mysqli_query($conexion, "UPDATE usuarios SET id_extreme='".$id_extreme."' WHERE username='".$username2."'") or die(mysql_error());
}
