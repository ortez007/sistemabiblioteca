    ...
    <table class="table table-bordered table-condensed table-responsive table-striped table-hover"  width="1300" border="0">
             ...
             <tr>
                 ...
                 <td bgcolor="#D6D6D6" class="colorencabezado"><b>Acciones</b></td>
                  ...
                  <?php
                       $consulta=mysqli_query($conexion, "select * from libros ORDER BY id_libro desc");
                       if (isset($_POST['txtbuscar'])){
                       $consulta=mysqli_query($conexion, "select * from libros where nombre like '%".$_POST['txtbuscar']."%'  ORDER BY id_libro desc"); 
                      }
