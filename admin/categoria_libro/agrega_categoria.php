...
switch($proceso){
	case 'Registro': mysqli_query($conexion, "INSERT INTO categorias (nombre_categoria) VALUES('$cate')");
	break;

	case 'Edicion': mysqli_query($conexion, "UPDATE categorias SET nombre_categoria = '$cate' where id_categoria = '$id'");
	break;
   }
