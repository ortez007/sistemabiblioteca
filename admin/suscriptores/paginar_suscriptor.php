...
include('../conexion.php');
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM suscriptores"));
    $nroLotes = 8;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion, "SELECT * FROM suscriptores LIMIT $limit, $nroLotes ");
