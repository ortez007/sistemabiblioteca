...
switch($proceso){
	case 'Registro': mysqli_query($conexion, "INSERT INTO usuario_estudiante (carnet, nombre, apellidos, email, anio, carrera) VALUES('$carnet','$nombre','$apellidos',
	                     '$email', '$anio', '$carrera')");
	break;
	case 'Edicion':	mysqli_query($conexion, "UPDATE usuario_estudiante SET carnet = '$carnet', nombre = '$nombre', apellidos = '$apellidos',
