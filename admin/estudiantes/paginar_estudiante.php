...
include('../libros/php/conexion.php');
    ...
    $nroProductos = mysqli_num_rows(mysql_query($conexion, "SELECT * FROM usuario_estudiante"));
    $nroLotes = 8;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion, "SELECT * FROM usuario_estudiante LIMIT $limit, $nroLotes ");
