...
<html lang="en">
    <head>
        ...
        <title>Acceso: Solo personal autorizado | Bibioteca UEES</title>
        <!-- CSS -->
        ...
        <link rel="shortcut icon" href="images/home/librito.ico">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
	                            	SOLO EL ADMINISTRADOR PUEDE TENER ACCESO A ESTE
                                    SISTEMA. 
                            	</p>
                            </div>
                        </div>
