...
$consulta=mysqli_query($conexion, "select * from libros where id_categoria = 11 limit 0,6");
...
<head>
    ...
    <title>Libros sobre Base Datos</title>
			...
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-5">
			            ...
			            <p>
			            	No puedes aprender ingeniería en sistemas sin saber los puntos claves que debes conocer sobre
							el tema y uno de ellos es el almacenamiento de toda la informacion en las bases de datos junto con 
							cada uno de sus elementos desde el código de estructuración hasta las exportaciones e importaciones
							de todos los datos que se van recopilando. Estos libros de bases de datos te ayudaran a mejorar tu 
